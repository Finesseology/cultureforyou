			...
			<center>
				<div className={styles.myDiv}>
					...
					<p className={styles.p}>
						By accessing this web site, you are agreeing to be bound by this Agreement. Culture For You
						reserves the right to update or modify this Agreement at any time without notice. If you do not
						agree to these terms, you are prohibited from accessing or using this site. Last updated: March
						11, 2023 Please read these Terms of Use (“Terms”, “Terms of Use”) carefully before using t he
						https://cultureforu.com website (the “Service”) operated by Culture For You (“us”, “we”, or
						“our”). Your access to and use of the Service is conditioned on your acceptance of and
						compliance with these Terms. These Terms apply to all visitors, users and others who access or
						use the Service. By accessing or using the Service you agree to be bound by these Terms. If you
						disagree with any part of the terms then you may not access the Service.<br></br>
					</p>
					...
					<p className={styles.p}>
						...
						the password that you use to access the Service and for any activities or actions under your
						password, whether your password is with our Service or a third-party service. You agree not to
						disclose your password to any third party. You must notify us immediately upon becoming aware of
					...
					<p className={styles.p}>
						...
						controlled by Culture For You. Culture For You has no control over, and assumes no
						responsibility for, the content, privacy policies, or practices of any third party web sites or
						services. You further acknowledge and agree that Culture For You shall not be responsible or
						...
						through any such web sites or services. We strongly advise you to read the terms and conditions
					...
					<p className={styles.p}>
						...
						simply discontinue using the Service. All provisions of the Terms which by their nature should
					...
					<p className={styles.p}>
						These Terms shall be governed and construed in accordance with the laws of United States without
